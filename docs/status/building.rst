...
The current status and version for the Building :term:`plug-ins<plug-in>`:
...
.. _pyxtal_step: https://qzhu2017.github.io/pyxtal_step/index.html

.. |pyxtal2| image:: https://codecov.io/gh/qzhu2017/pyxtal_step/branch/master/graph/badge.svg
   :target: https://codecov.io/gh/qzhu2017/pyxtal_step
   :alt: Code Coverage

.. |pyxtal3| image:: https://img.shields.io/lgtm/grade/python/g/qzhu2017/pyxtal_step.svg?logo=lgtm&logoWidth=18
   :target: https://lgtm.com/projects/g/qzhu2017/pyxtal_step/context:python
   :alt: Code Quality

.. |pyxtal4| image:: https://github.com/qzhu2017/pyxtal_step/workflows/Documentation/badge.svg
   :target: https://github.com/qzhu2017/pyxtal_step/actions/workflows/Docs.yaml
   :alt: Documentation Status

.. |pyxtal6| image:: https://img.shields.io/pypi/v/pyxtal_step.svg?cacheSeconds=36000
   :target: https://pypi.python.org/pypi/pyxtal_step
   :alt: PyPi VERSION

.. |pyxtal7| image:: https://img.shields.io/pypi/dm/pyxtal_step?cacheSeconds=36000
   :target: https://pypistats.org/packages/pyxtal_step
   :alt: PyPI - Downloads
