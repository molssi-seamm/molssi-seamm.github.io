...
these types of simulations, SEAMM provides an ideal environment for discovery. It will 
help you focus on the science rather than technicalities of using the software.
